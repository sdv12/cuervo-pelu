      ...
      <div className="mx-auto grid max-w-[1080px] grid-cols-1 gap-10 md:grid-cols-2">
        <div>
          ...
          <div className="flex justify-between border-b border-linea py-2.5 text-[0.95rem] dark:border-navy-border">
            <span className="text-tinta-suave dark:text-navy-soft">Martes a viernes</span><span>10:00 — 20:00</span>
          </div>
          <div className="flex justify-between border-b border-linea py-2.5 text-[0.95rem] dark:border-navy-border">
            <span className="text-tinta-suave dark:text-navy-soft">Sábados</span><span>9:00 — 18:00</span>
          </div>
          <div className="flex justify-between border-b border-linea py-2.5 text-[0.95rem] dark:border-navy-border">
        ...
        <div>
          ...
          <a
            className="mt-3 inline-flex items-center gap-2 text-[0.95rem] font-semibold text-rojo no-underline dark:text-navy-accent"
